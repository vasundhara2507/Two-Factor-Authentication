...
def faceDetection(test_img):
    ...
    face_haar_cascade=cv2.CascadeClassifier("C:\\Users\\poona\\Downloads\\Two Factor Authentication\\templates\\HaarCascade\\haarcascade_frontalface_default.xml")#Load haar classifier
