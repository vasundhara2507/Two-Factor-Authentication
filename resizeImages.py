...
for path, subdirnames, filenames in os.walk("C:\\Users\\poona\\Downloads\\Two Factor Authentication\\templates\\trainingImages"):
    ...
    for filename in filenames:
      ...
      new_path="C:\\Users\\poona\\Downloads\\Two Factor Authentication\\templates\\resizedTrainingImages"+"/"+str(id)
